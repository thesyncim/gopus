...
func kfBfly4M1CoreSIMD(fout []kissCpx, n int) {
	...
	for block := 0; block < blocks; block++ {
		...
		a0r, a0i := a0f.ConcatEven(a0f).BitsToFloat32(), a0f.ConcatOdd(a0f).BitsToFloat32()
		a1r, a1i := a1f.ConcatEven(a1f).BitsToFloat32(), a1f.ConcatOdd(a1f).BitsToFloat32()
		a2r, a2i := a2f.ConcatEven(a2f).BitsToFloat32(), a2f.ConcatOdd(a2f).BitsToFloat32()
		a3r, a3i := a3f.ConcatEven(a3f).BitsToFloat32(), a3f.ConcatOdd(a3f).BitsToFloat32()

		s0r, s0i := a0r.Sub(a2r), a0i.Sub(a2i)
		f0r, f0i := a0r.Add(a2r), a0i.Add(a2i)
		s1r, s1i := a1r.Add(a3r), a1i.Add(a3i)
		f2r, f2i := f0r.Sub(s1r), f0i.Sub(s1i)
		f0r, f0i = f0r.Add(s1r), f0i.Add(s1i)
		s1r, s1i = a1r.Sub(a3r), a1i.Sub(a3i)
		f1r, f1i := s0r.Add(s1i), s0i.Sub(s1r)
		f3r, f3i := s0r.Sub(s1i), s0i.Add(s1r)

		v0 := f0r.ToBits().InterleaveLo(f0i.ToBits()).BitsToFloat32()
		v1 := f1r.ToBits().InterleaveLo(f1i.ToBits()).BitsToFloat32()
		v2 := f2r.ToBits().InterleaveLo(f2i.ToBits()).BitsToFloat32()
		v3 := f3r.ToBits().InterleaveLo(f3i.ToBits()).BitsToFloat32()
		v01 := v0.ToBits().ReshapeToUint64s().InterleaveLo(v1.ToBits().ReshapeToUint64s()).ReshapeToUint32s().BitsToFloat32()
		v23 := v2.ToBits().ReshapeToUint64s().InterleaveLo(v3.ToBits().ReshapeToUint64s()).ReshapeToUint32s().BitsToFloat32()
		v45 := v0.ToBits().ReshapeToUint64s().InterleaveHi(v1.ToBits().ReshapeToUint64s()).ReshapeToUint32s().BitsToFloat32()
		v67 := v2.ToBits().ReshapeToUint64s().InterleaveHi(v3.ToBits().ReshapeToUint64s()).ReshapeToUint32s().BitsToFloat32()
		storeF32x4(p, v01)
