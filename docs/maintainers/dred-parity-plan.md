...
- finish the same no-link compile-footprint split for top-level decoder DRED internals without weakening the existing dormant runtime contract or shared decoder tests
