...
- decoder-level parity beyond the required mono explicit/live matrix, selected 16 kHz Hybrid mono live-sequence seams, CELT/Hybrid stereo cached/live first/second-loss and next-packet handoff matrices, selected 16 kHz CELT/Hybrid stereo explicit first-loss probes, explicit first-loss and recovery lifecycle/cursor seams, 48 kHz / 16 kHz SILK WB explicit mono first-loss seams, the required 48 kHz SILK WB explicit stereo first-loss seam, stereo cached recovery lifecycle/cursor seams, and the covered multistream CELT/Hybrid/SILK DRED consumers, especially broader SILK stereo packet/mode matrices, broader multistream packet/mode coverage, broader packet coverage, and the final supported-surface decisions for what graduates from quarantine
...
- Final/non-final uncoupled mono, final/non-final single-coupled stereo, and final/non-final non-leading second-coupled
...
- the 48 kHz mono CELT `FRAME_DRED` bridge, selected 16 kHz CELT/Hybrid stereo explicit first-loss probes, CELT/Hybrid stereo first/second-loss, next-packet, and recovery matrices, 48 kHz / 16 kHz SILK WB explicit mono first-loss seams, the 48 kHz SILK WB explicit stereo first-loss seam, stereo cached recovery lifecycle/cursor seams, the 48 kHz mono Hybrid SWB/FB first-loss/handoff seams, and the final/non-final uncoupled mono, final/non-final single-coupled stereo, and final/non-final non-leading second-coupled multistream CELT/Hybrid/SILK consumers are covered by required gates, with Hybrid now following the libopus-shaped Hybrid PLC base; the next decoder gap is broader SILK stereo and multistream packet/mode coverage
