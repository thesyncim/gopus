...
On amd64, CELT prefilter pitch, prefilter inner-product, pitch-autocorr,
and tone-LPC correlation helpers intentionally use the deterministic scalar float32 path for
