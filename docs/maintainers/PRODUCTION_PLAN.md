...
- CI and `make verify-production` include the unsupported-controls DRED parity sweep as a required gate, covering the exercised encoder carried-payload matrix, bootstrap, and bookkeeping seams.
