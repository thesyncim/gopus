...
- The docs contract gate pins default public API shape, unsupported-control quarantine, packet-extension dormancy/framing, and root repacketizer libopus fixture/envelope behavior before the heavier parity lanes run.
