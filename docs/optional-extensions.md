...
coverage, top-level decoder recovery/bridge lifecycle coverage, decoder cached recovery bookkeeping parity,
...
recovery/bridge lifecycle coverage, cached DRED recovery bookkeeping, and
