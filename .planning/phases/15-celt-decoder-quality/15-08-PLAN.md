...
@internal/testvectors/compliance_test.go (test vector infrastructure)
</context>
...
<task type="auto">
  ...
  <action>
Create celt_debug_test.go with tests that decode CELT test vectors with tracing enabled.
