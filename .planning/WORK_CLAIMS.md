...
- claim: id=codex-20260311-013016; agent=codex; status=released; paths=celt/,.planning/; updated=2026-03-11T22:24:03Z; expires=2026-03-11T22:24:03Z; note=decode output and cwrs perf loop after PR289 merge
...
- claim: id=codex-20260312-163532; agent=codex; status=released; paths=encoder.go,decoder.go,multistream.go,encoder_test.go,decoder_test.go,multistream_test.go; updated=2026-03-12T16:55:02Z; expires=2026-03-12T16:55:02Z; note=dedupe wrapper ctl validation and extension stubs
...
- claim: id=codex-20260312-165519; agent=codex; status=released; paths=encoder.go,decoder.go,multistream.go,encoder_test.go,decoder_test.go,multistream_test.go; updated=2026-03-12T17:14:02Z; expires=2026-03-12T17:14:02Z; note=larger wrapper cleanup: file split plus shared test helpers
- claim: id=codex-20260312-171309; agent=codex; status=released; paths=.planning/ACTIVE.md; updated=2026-03-12T17:14:02Z; expires=2026-03-12T17:14:02Z; note=log bigger wrapper split and test-helper cleanup evidence
- claim: id=codex-20260312-171711; agent=codex; status=released; paths=encoder.go,multistream.go,encoder_test.go,multistream_test.go,.planning/ACTIVE.md; updated=2026-03-12T17:33:10Z; expires=2026-03-12T17:33:10Z; note=expand wrapper cleanup PR with application and encode/decode file split
- claim: id=codex-20260312-180020; agent=codex; status=released; paths=decoder.go,decoder_test.go,.planning/ACTIVE.md; updated=2026-03-12T18:08:39Z; expires=2026-03-12T18:08:39Z; note=split decoder public and FEC glue into dedicated files with shared test helpers
...
- claim: id=codex-20260314-143701; agent=codex; status=released; paths=encoder/,celt/,silk/,multistream/,container/ogg/,examples/,testvectors/,tools/,go.mod,README.md,.planning/; updated=2026-03-14T14:39:27Z; expires=2026-03-14T14:39:27Z; note=repo-wide gofmt simplify pass
- claim: id=codex-20260314-145314; agent=codex; status=released; paths=README.md,stream.go,container/ogg/,celt/,silk/,hybrid/,rangecoding/,plc/,multistream/,.planning/; updated=2026-03-14T15:07:55Z; expires=2026-03-14T15:07:55Z; note=API and docs audit follow-up
- claim: id=codex-20260314-151713; agent=codex; status=released; paths=stream.go,stream_test.go,container/ogg/,.planning/; updated=2026-03-14T15:38:34Z; expires=2026-03-14T15:38:34Z; note=stream correctness follow-up: reset short writes granules
- claim: id=codex-20260314-153547; agent=codex; status=active; paths=.planning/,tools/,Makefile,AGENTS.md,CLAUDE.md,CODEX.md,README.md,.gitignore,program.md; updated=2026-03-14T15:35:47Z; expires=2026-03-14T19:35:47Z; note=replace planning/claim workflow with autoresearch-style experiment loop
