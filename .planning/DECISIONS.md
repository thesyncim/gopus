...
do_not_repeat_until: amd64 CELT kernel inventory, required ISA level, or the generic fallback semantics change in a way that invalidates the current runtime-dispatch mapping or fallback guards.
owner: codex
