//go:build gopus_dred && !gopus_unsupported_controls && !gopus_qext
// +build gopus_dred,!gopus_unsupported_controls,!gopus_qext
	...
	tests := []struct {
		...
		},
		{
			...
			want: []string{
				...
				"GetFinalRange", "InBandFEC", "LSBDepth", "Lookahead", "MaxBandwidth", "PacketLoss",
