...
const tmpQEXTForceIntensityEnabled = false
const tmpQEXTForceIntensityValue = 0
const tmpQEXTForceDualStereoEnabled = false
const tmpQEXTForceDualStereoValue = false
const tmpQEXTHeaderDumpEnabled = false
const tmpQEXTDisableMainExtraEnabled = false
const tmpQEXTDisableExtraBandsEnabled = false
const tmpQEXTDisableMainExtraQuantEnabled = false
const tmpQEXTDisableMainExtraPulsesEnabled = false
const tmpQEXTDisableMainThetaExtEnabled = false
