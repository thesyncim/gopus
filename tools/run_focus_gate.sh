...
core_oracles_celt='TestCELT(Log2|Exp2)MatchesLibopusFloatApprox|TestCELTAngleMathMatchesLibopusFloatPath|TestCELTStereoIthetaQ30MatchesLibopus|TestCELTBitexact(Cos|Log2Tan)MatchesLibopus|TestCELTIntegerMathMatchesLibopus'
