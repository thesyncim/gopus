...
DEFAULT_PACKET_PARSER_ROOT_RUN = 'Test(ParsePacketCode0|ParsePacketCode1|ParsePacketCode2|ParsePacketCode3CBR|ParsePacketCode3VBR|TwoByteFrameLength|ParsePacketErrors|ParsePacketRejectsLibopusEnvelopeViolations|ParsePacketCode3MaxFrames|ParsePacketCode3ContinuationPadding)'
DEFAULT_MULTISTREAM_PARSER_RUN = 'Test(ParseOpusPacketRejectsLibopusEnvelopeViolations|PacketDurationRejectsLibopusEnvelopeViolation|ParseMultistreamPacketWithSelfDelimitedCode3|SelfDelimitedPacketDropsOrdinaryPadding)'
DEFAULT_REPACKETIZER_ROOT_RUN = 'Test(RepacketizerParityWithLibopusFixture|RepacketizerRejectsLibopusParserEnvelopeViolations)'
