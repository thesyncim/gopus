...
test-dred-tag: ensure-libopus
	...
	run_json env GOPUS_TEST_TIER=parity GOPUS_STRICT_LIBOPUS_REF=1 $(GO_WORK_ENV) $(GO) test -tags gopus_dred . -run 'Test(EncoderSilkMono20msPrimaryFrameByteExactMatchesLibopus|EncoderSilkMono40msPrimaryFrameByteExactMatchesLibopus|EncoderSilkMono60msPrimaryFrameByteExactMatchesLibopus|EncoderSilkStereo20msPrimaryFrameByteExactMatchesLibopus|EncoderCarriedDREDPayloadMatchesLibopusCELTFullband20ms|EncoderCarriedDREDPayloadMatchesLibopusSilkWideband20ms|EncoderCarriedDREDPayloadMatchesLibopusSilkWideband40ms|EncoderCarriedDREDPayloadMatchesLibopusSilkWideband60ms|EncoderCarriedDREDPayloadMatchesLibopusHybridFullband20msPayloadOnly|EncoderCarriedDREDPayloadMatchesLibopusHybridFullband20msStereo|EncoderCarriedDREDPayloadMatchesLibopusSilkWideband20msStereo|MultistreamEncoderCarriedDREDPayloadMatchesLibopusSilkWideband20msStereo)' -count=1; \
