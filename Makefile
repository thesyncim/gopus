...
test-unsupported-controls-tag:
	$(GO_WORK_ENV) $(GO) test -tags gopus_unsupported_controls . -run 'Test(SupportsOptionalExtension|UnsupportedControlsBuildExposesQuarantinedTopLevelControls|UnsupportedControlsBuildPublicAPIContract|DREDDecoderParseRequiresModel|DREDDecoderParseAndProcessRetainsMetadata|DREDDecoderParseClearsStateWhenPacketHasNoDRED|DREDDecoderParseClearsStateOnMalformedPacket|StandaloneDREDParseMatchesLibopus|StandaloneDREDProcessMatchesLibopusOnRealPacket|StandaloneDREDProcessLifecycleMatchesLibopusOnRealPacket|StandaloneDREDRecoveryWindowMatchesLibopus|StandaloneDREDRecoveryQueueMatchesLibopus|DecoderCachedDREDRecoveryMatchesLibopusLifecycle|DecoderCachedDREDRecoveryCursorAdvancesAcrossLosses|DecoderCachedHybridDREDDecodeMatrixMatchesExplicitDREDOracle|DecoderCachedHybridDREDThenNextPacketMatchesExplicitDREDOracle|DecoderCachedHybridDREDThenNextPacketMatchesLiveSequenceOracle|DecoderCachedHybridDREDSecondLossMatchesExplicitDREDOracle|DecoderCachedHybridSecondLossThenNextPacketMatchesExplicitDREDOracle|DecoderCachedHybridSecondLossThenNextPacketMatchesLiveSequenceOracle|DecoderFirstLossNeuralConcealmentMatchesExplicitDREDOracle|DecoderFirstLossNeuralConcealmentMatchesLiveSequenceOracle|DecoderFirstLossThenNextPacketMatchesLiveSequenceOracle|DecoderSecondLossNeuralConcealmentMatchesExplicitDREDOracle|DecoderSecondLossNeuralConcealmentMatchesLiveSequenceOracle|DecoderSecondLossThenNextPacketMatchesLiveSequenceOracle|DecoderExplicitDREDWarmup48kStateMatchesLibopus|DecoderExplicitDREDCELT48kBridgeMatchesLibopusFirstLoss|DecoderExplicitDREDCELT48kBridgeMatchesLibopusSecondLoss|DecoderExplicitDREDDecodeMatchesCachedPath|DecoderExplicitDREDDecodeMatchesLibopus|DecoderExplicitDREDDecode16kMatchesLibopus|DecoderExplicitDREDDecode16kMatchesCachedPath|DecoderExplicitDREDDecodeSecondLossMatchesCachedPath|DecoderExplicitDREDDecodeSecondLossMatchesLibopus|DecoderExplicitDREDDecodeSecondLoss16kMatchesLibopus|DecoderExplicitDREDDecodeOffsetMatrixMatchesLibopus|DecoderExplicitDREDDecodeThenNextPacketMatchesLibopus|DecoderExplicitDREDDecodeThenNextPacket16kMatchesLibopus|DecoderExplicitHybridDREDDecodeMatrixMatchesLibopus|DecoderExplicitHybridDREDDecodeThenNextPacketMatchesLibopus|DecoderExplicitSecondLossThenNextPacketMatchesLibopus|DecoderExplicitSecondLossThenNextPacket16kMatchesLibopus|DecoderExplicitSecondLossThenNextPacketMatchesCachedPath|DecoderExplicitDREDDecodeFrameSizeMatrixMatchesLibopus|DecoderExplicitDREDDecode16kFrameSizeMatrixMatchesLibopus|DecoderExplicitDREDDecodeSecondLossFrameSizeMatrixMatchesLibopus|DecoderExplicitDREDDecodeThenNextPacketFrameSizeMatrixMatchesLibopus|DecoderExplicitSecondLossThenNextPacketFrameSizeMatrixMatchesLibopus|DecoderExplicitSecondLossThenNextPacketFrameSizeMatrixMatchesCachedPath)|ExampleSupportsOptionalExtension' -count=1
