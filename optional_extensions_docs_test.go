...
func TestOptionalExtensionDocsContract(t *testing.T) {
	...
	for _, needle := range []string{
		...
		"Hybrid fullband 20/40 ms mono and 20 ms stereo carried-payload/primary-frame seams",
		"current mono decoder explicit/live numerical matrix",
		"Hybrid primary-frame byte exactness is covered for the current carried-packet seams",
