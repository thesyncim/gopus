...
func encodeTest[T testFloatPCM](enc *Encoder, pcm []T, frameSize int) ([]byte, error) {
	return enc.Encode(testPCM32(pcm), frameSize)
}

func encodeWithAnalysisMaxBytesTest[T testFloatPCM, U testFloatPCM](enc *Encoder, pcm []T, frameSize int, analysisPCM []U, maxDataBytes int) ([]byte, error) {
