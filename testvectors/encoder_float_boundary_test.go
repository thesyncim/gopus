...
//   - amd64 pure-Go build (-tags nosimd, gopusBuildIsSIMD==false): the Go amd64
...
//
// The amd64 assembly/SIMD build (gopusBuildIsSIMD==true) is the strict bit-exact
...
func encoderCELTFloatBoundaryBuild() bool {
	return runtime.GOARCH == "arm64" || !gopusBuildIsSIMD
}
