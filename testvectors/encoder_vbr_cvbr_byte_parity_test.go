...
const (
	opusApplicationVoIP   = uint32(2048)
	opusApplicationAudio  = uint32(2049)
	opusApplicationLowDelay = uint32(2051)
)
...
// libopus OPUS_SIGNAL_* numeric constants.
const (
	opusSignalAuto  = uint32(0xFFFFFC18) // -1000
