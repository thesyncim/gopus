...
func TestQuantizeLSF(t *testing.T) {
	...
	stage1Idx, residuals, interpIdx := enc.quantizeLSF(lsfQ15, BandwidthWideband, 2, 200, 4, -1)
...
func TestQuantizeLSFNarrowband(t *testing.T) {
	...
	stage1Idx, residuals, interpIdx := enc.quantizeLSF(lsfQ15, BandwidthNarrowband, 1, 200, 4, -1)
