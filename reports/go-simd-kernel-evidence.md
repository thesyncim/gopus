...
| 47 | `xcorrKernelAVX8` | amd64 | `internal/silk/pitch_xcorr_kernel_simd_amd64.go`; `internal/silk/pitch_xcorr_kernel_avx_amd64.go` | archsimd / scalar | Prior baseline: SILK pitch search L×P=120×300, old asm→Go SIMD: Xeon 8573C 1,198→6,895; EPYC 7763 1,747→7,665; earlier EPYC split SIMD 11,206 | 0 | Prior one-pass Go SIMD timing; transposed length-120–240 candidate awaits native parity and paired timing. The Go path preserves the zero-allocation contract. |
