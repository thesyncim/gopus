...
| `celt/stereo.go` | 32 |
| `celt/hybrid_encode_helpers.go` | 30 |
| `encoder/hybrid.go` | 30 |
| `celt/channel_adapters.go` | 28 |
| `celt/bands.go` | 27 |
| `celt/bands_encode.go` | 25 |
| `celt/pvq.go` | 24 |
...
| `celt/encode_frame.go` | 13 |
| `celt/hybrid_encode_helpers.go` | 12 |
