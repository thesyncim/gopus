...
| File | Approx matches |
|---|---:|
| `celt/bands_quant.go` | 203 |
| `celt/mdct.go` | 80 |
| `celt/encode_frame.go` | 80 |
| `celt/encoder.go` | 62 |
...
| `celt/tonality.go` | 38 |
| `celt/hybrid_encode_helpers.go` | 35 |
| `celt/synthesis.go` | 33 |
| `celt/stereo.go` | 32 |
| `encoder/hybrid.go` | 30 |
| `celt/bands_encode.go` | 29 |
...
| File | Approx matches |
|---|---:|
| `celt/bands_quant.go` | 35 |
| `celt/hybrid_encode_helpers.go` | 24 |
| `celt/mdct_encode.go` | 21 |
| `celt/encode_frame.go` | 19 |
| `encoder/hybrid.go` | 18 |
| `celt/channel_adapters.go` | 13 |
| `celt/mdct.go` | 13 |
| `celt/synthesis.go` | 13 |
...
| `celt/pvq_search.go` | 4 |
| `celt/qext_cubic.go` | 4 |
| `celt/transient.go` | 4 |
| `internal/lpcnetplc/analysis.go` | 4 |
