...
`28624977471` on a GitHub linux/amd64 runner (`go1.25.0`, AMD EPYC 7763):

| Benchmark | CI result |
| --- | ---: |
| `BenchmarkEncoderEncode_CallerBuffer` | 93,725 ns/op, 0 B/op, 0 allocs/op |
| `BenchmarkEncoderEncodeInt16` | 94,484 ns/op, 0 B/op, 0 allocs/op |
| `BenchmarkDecoderDecode_CELT` | 20,735 ns/op, 0 B/op, 0 allocs/op |
| `BenchmarkDecoderDecodeInt16` | 22,448 ns/op, 0 B/op, 0 allocs/op |
...
| Path | gopus/libopus |
| --- | ---: |
| Decode vectors, Float32 | 1.339x |
| Decode vectors, Int16 | 1.330x |
| Encode, all Float32 cases | 1.500x |
| Encode, CELT-FB-20ms-stereo-128k | 1.546x |
| Encode, CELT-FB-5ms-mono-64k | 1.472x |
| Encode, Hybrid-FB-20ms-mono-64k | 1.530x |
| Encode, Hybrid-FB-20ms-stereo-96k | 1.677x |
| Encode, SILK-WB-20ms-mono-32k | 1.426x |
